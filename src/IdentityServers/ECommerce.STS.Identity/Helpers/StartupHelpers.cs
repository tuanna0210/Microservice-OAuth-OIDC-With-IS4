...
using ECommerce.STS.Identity.Configuration;
using ECommerce.STS.Identity.Configuration.ApplicationParts;
using ECommerce.STS.Identity.Configuration.Constants;
using ECommerce.STS.Identity.Configuration.Interfaces;
using ECommerce.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace ECommerce.STS.Identity.Helpers
{
