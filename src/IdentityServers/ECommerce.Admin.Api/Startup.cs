...
using ECommerce.Admin.Api.Configuration;
using ECommerce.Admin.Api.Configuration.Authorization;
using ECommerce.Admin.Api.ExceptionHandling;
using ECommerce.Admin.Api.Helpers;
using ECommerce.Admin.Api.Mappers;
using ECommerce.Admin.Api.Resources;
using ECommerce.Admin.EntityFramework.Shared.DbContexts;
using ECommerce.Admin.EntityFramework.Shared.Entities.Identity;
using Skoruba.IdentityServer4.Shared.Configuration.Helpers;
using ECommerce.Shared.Dtos;
using ECommerce.Shared.Dtos.Identity;

namespace ECommerce.Admin.Api
{
