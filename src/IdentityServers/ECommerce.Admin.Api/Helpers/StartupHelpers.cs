...
using ECommerce.Admin.Api.AuditLogging;
using ECommerce.Admin.Api.Configuration;
using ECommerce.Admin.Api.Configuration.ApplicationParts;
using ECommerce.Admin.Api.Configuration.Constants;
using ECommerce.Admin.Api.Helpers.Localization;
...
namespace ECommerce.Admin.Api.Helpers
{
